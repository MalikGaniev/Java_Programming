...
public class Pizza {
    ...
    public double calcCost(){
        ...
        switch(size){
            ...
            case 'l':
                ...
                break;
            default:{
                System.err.println("Invalid size of pizza "+size);
            }

        }
        return totalPrice;
    }// to calculate the total price of the pizza,and returns it as double
    ...
    public String toString() {
        return "Pizza{" +
         ...
         '}';
    }//displaying pizza information when its call
}
/*
