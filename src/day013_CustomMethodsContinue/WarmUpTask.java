...
public static void calculate(double number,double num2,char mathOperator){
        if(mathOperator=='/'){
...
switch (mathOperator){
    case'+':
        System.out.println(number+" "+mathOperator+" "+num2+" = "+(number+num2));
        break;
    case '-':result=number-num2;
        System.out.println(number+" "+mathOperator+" "+num2+" = "+(number-num2));
        break;
    case'*':
        System.out.println(number+" "+mathOperator+" "+num2+" = "+(number*num2));
